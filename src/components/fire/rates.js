...
const class1 = [
    ...
    {slug: 'officeclass1', name: 'Office', rate: 0.09},
    {slug: 'homeclass1', name: 'Home', rate: 0.06},
...
const class2 = [
    {slug: 'shopclass2', name: 'Shop', rate: 0.17},
    {slug: 'godownclass2', name: 'Godown', rate: 0.13},
    {slug: 'homeclass2', name: 'Home', rate: 0.09},
