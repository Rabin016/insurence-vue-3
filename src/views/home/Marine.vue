...
import { convertCurrency, bankCalculate, rateCalculate } from "../../components/calculation/calculate";
...
const submitInfo = () => {
    ...
    // Total
    premium.value.total = premium.value.net + premium.value.vat + premium.value.stamp
